...
1. [ ] **Initialize Rust workspace** (`cargo init`).
2. [ ] **Add CLI dependencies**: `cargo add clap@4.5.40`.
3. [ ] **Add serialization dependencies**: `cargo add serde@1.0.219 serde_json@1.0.140`.
4. [ ] **Add GUI framework**: `cargo add eframe@0.31.1`.
5. [ ] **Port core structs**: `Species`, `Stats`, `ServerMultipliers`.
6. [ ] **Implement JSON loading tests** to verify data parsing.
